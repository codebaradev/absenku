...
import { updateGeofence } from "@/lib/actions/lokasi";
...
export function LokasiClient({ schoolName, latitude, longitude, radiusMeters }: Props) {
  ...
  return (
    <div className="flex flex-col gap-6">
      <section className="flex flex-col gap-1">
        <h2 className="text-xl font-semibold text-[#0b1c30]">Titik Lokasi Absensi</h2>
        <p className="text-sm text-[#45464d]">
          Geofence GPS untuk absen masuk/pulang — {schoolName}
        </p>
      </section>
